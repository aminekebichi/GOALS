...
> Only run this after at least one season of FotMob Premier League data is scraped.
...
```powershell
# 2024/25 Premier League (default)
...
list — played and unplayed — and saves it to `data/47/{season}/output/fixtures.parquet`.
...
Before training on the full dataset, scrape Premier League data for the missing seasons
by running `fotmob_final.ipynb` four times with these settings:
